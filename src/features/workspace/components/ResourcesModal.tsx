                ...
                <NavButton
                  ...
                  icon={
                    <svg
                      ...
                      className="shrink-0"
                    >
                      <path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A5.5 5.5 0 0 0 7.5 5C7.5 6.3 8 7.6 9 8.5c.8.8 1.3 1.5 1.5 2.5" />
            ...
            {activeTab === "get-started" && (
              <div className="space-y-8 max-w-2xl animate-fade-up">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-5 rounded-2xl border border-neutral-200/60 bg-neutral-50/20 hover:border-neutral-300 transition flex flex-col items-start">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                ...
                <div className="border-t border-neutral-100 pt-6">
                  ...
                  <div className="mt-4 space-y-4">
                    <div
                      className="flex gap-4 p-4 rounded-xl border border-neutral-100 hover:bg-neutral-50 transition cursor-pointer items-center"
                      onClick={() => setActiveTab("guides")}
                    >
                      <svg
                        width="20"
...
function NavButton({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "w-full text-left px-3 py-2 rounded-lg text-xs font-bold transition-all duration-150 flex items-center gap-2",
        active
